...
public class MyinfoPageObjects {
	...
	private By EmployeeId = By
			.xpath("//div[@class='orangehrm-edit-employee-content']//div[2]//div[1]//div[1]//div[1]//div[2]//input[1]");
	...
	private By nationalitydropdown = By.xpath(
			"//body[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[2]/div[1]/form[1]/div[3]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[2]/i[1]");
	private By nationalityoption = By.xpath("//div[@class='oxd-select-option']");//// div[@class='oxd-select-text-input']

	private By maritialstatusarrow = By.xpath("(//i[@class='oxd-icon bi-caret-down-fill oxd-select-text--arrow'])[2]");
	private By maritialstatus = By.xpath("(//div[@class='oxd-select-option'])[3]");
